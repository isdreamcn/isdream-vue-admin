  ...
  <FormWrapper ref="formRef">
    <form class="form" @submit.prevent="onSubmit">
      <div class="form__header">
        <h1 class="form__header__title">注册</h1>
      ...
      <div class="form__tip-unavailable">
        ...
        <div class="form__tip-unavailable__text">注册功能暂未开放</div>
      </div>
      ...
      <FormItem
        ...
        :rules="[
          (val) => !val && '请输入确认密码',
          (val) => val && signinForm.password !== val && '密码和确认密码不一致'
        ]"
      />
      <FormItem
        v-model="signinForm.emailCaptcha"
        label="邮箱验证码"
      ...
      <FormButton :loading="signinLoading">注册</FormButton>
...
const { signinLoading, signinForm, requestStatus, requestMessage, signin } =
  useSignin()
